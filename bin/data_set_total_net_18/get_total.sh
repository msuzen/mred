...
convert -rotate 90 actual_queue_size.eps actual_queue_size_net_18.png
mv actual_queue_size.eps actual_queue_size_net_18.eps
echo "converting actual_size.ps"
convert -rotate 90  queue_size.eps queue_size_net_18.png
mv  queue_size.eps queue_size_net_18.eps
echo "converting traffic_compare.ps"
convert -rotate 90 traffic_compare.eps traffic_compare_net_18.png
mv traffic_compare.eps traffic_compare_net_18.eps
